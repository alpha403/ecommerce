<nav class="side-nav">
                ...
                <ul>
                    <li>
                        <a href="dashboard" class="side-menu <?php echo $dashboard; ?>">
                            <div class="side-menu__icon"> <i data-feather="home"></i> </div>
                            <div class="side-menu__title"> Dashboard </div>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:;" id="catalog_option" class="side-menu <?php echo $catalog; ?>">
                            <div class="side-menu__icon"> <i data-feather="layers"></i> </div>
                            <div class="side-menu__title"> Catalog <i data-feather="chevron-down" class="side-menu__sub-icon"></i> </div>
                        </a>
                        <ul class="">
							<li>
                                <a href="brands" class="side-menu">
                            ...
                            <li>
                                <a href="sub-categories" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
							...
							<li>
                                <a href="collections" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                                    <div class="side-menu__title"> Collections </div>
                                </a>
                            </li>
                        </ul>
                    </li>
					...
					<li>
                        <a href="#" class="side-menu">
                            ...
                            <div class="side-menu__title"> Pop Ups </div>
                        </a>
                    </li>
					<li>
                        <a href="#" class="side-menu">
                            <div class="side-menu__icon"> <i data-feather="dollar-sign"></i> </div>
                            <div class="side-menu__title"> Shipping Rates </div>
                        </a>
                    </li>
					<li>
                        <a href="#" class="side-menu">
                            <div class="side-menu__icon"> <i data-feather="edit"></i> </div>
                            <div class="side-menu__title"> Taxes </div>
                        </a>
                    </li>
