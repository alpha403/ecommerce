<div class="mobile-menu md:hidden">
            <div class="mobile-menu-bar">
                <a href="" class="flex mr-auto">
                    <img class="w-6" src="images/logo-white.png" style="width:120px;">
                </a>
            ...
            <ul class="border-t border-theme-24 py-5 hidden">
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        ...
                        <div class="menu__title"> Catalog <i data-feather="chevron-down" class="menu__sub-icon"></i> </div>
                    </a>
                    <ul class="">
                        <li>
                            <a href="brands" class="menu">
                        ...
                        <li>
                            <a href="sub-categories" class="menu">
                                <div class="menu__icon"> <i data-feather="activity"></i> </div>
                                <div class="menu__title"> Sub Categories </div>
                            </a>
                        </li>
						<li>
						...
						<li>
                            <a href="collections" class="menu">
                                <div class="menu__icon"> <i data-feather="activity"></i> </div>
                                <div class="menu__title"> Collections </div>
                            </a>
                        </li>
                    </ul>
                </li>
				...
				<li>
                    <a href="#" class="menu">
                        <div class="menu__icon"> <i data-feather="copy"></i> </div>
                        <div class="menu__title"> Pop Up </div>
                    </a>
                </li>
				<li>
                    <a href="#" class="menu">
                        <div class="menu__icon"> <i data-feather="dollar-sign"></i> </div>
                        <div class="menu__title"> Shipping Rates </div>
                    </a>
                </li>
				<li>
                    <a href="#" class="menu">
                        <div class="menu__icon"> <i data-feather="edit"></i> </div>
                        <div class="menu__title"> Taxes </div>
                    </a>
                </li>
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        ...
                        <div class="menu__title"> Territory <i data-feather="chevron-down" class="menu__sub-icon"></i> </div>
                    </a>
                    <ul class="">
                        <li>
                            <a href="#" class="menu">
