...
<head>
    ...
    <title>Rtaze - Home</title>
    <meta name="keywords" content="HTML5 Template">
    <meta name="author" content="p-themes">
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/images/icons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="assets/images/icons/fav.png">
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/icons/fav.png">
    ...
    <div class="page-wrapper">
                ...
                <div class="container">
                    <div class="header-left">
                        <ul class="top-menu top-link-menu d-none d-md-block">
                            <li>
                                <a href="#">Links</a>
                                <ul>
                                    <li><a href="tel:#"><i class="las la-phone"></i>Call: +91-9998284428</a></li>
                                </ul>
                            </li>
                        </ul><!-- End .top-menu -->
                    </div><!-- End .header-left -->
                    ...
                    <div class="header-right">
                        <div class="social-icons social-icons-color">
                            <a href="#" class="social-icon social-facebook" title="Facebook" target="_blank"><i class="lab la-facebook-f"></i></a>
                            <a href="#" class="social-icon social-twitter" title="Twitter" target="_blank"><i class="lab la-twitter"></i></a>
                            <a href="#" class="social-icon social-instagram" title="Pinterest" target="_blank"><i class="lab la-instagram"></i></a>
                            <a href="#" class="social-icon social-pinterest" title="Instagram" target="_blank"><i class="lab la-pinterest-p"></i></a>
                        </div><!-- End .soial-icons -->
                        <ul class="top-menu top-link-menu">
                            <li>
                                <a href="#">Links</a>
                                <ul>
                                    <li><a href="#signin-modal" data-toggle="modal"><i class="las la-user"></i>Login</a></li>
                                </ul>
                            </li>
                        </ul><!-- End .top-menu -->
                ...
                <div class="container">
                    ...
                    <div class="header-center">
                        <a href="index.html" class="logo">
                            <img src="assets/images/page/logo.png">
                        </a>
                    </div><!-- End .header-left -->
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-cart-products">
                                    <div class="product">
                                        ...
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="las la-times"></i></a>
                                    </div><!-- End .product -->
                                ...
                                <div class="dropdown-cart-action">
                                    ...
                                    <a href="#" class="btn btn-outline-primary-2"><span>Checkout</span<i class="las la-arrow-right"></i></a>
                                </div><!-- End .dropdown-cart-total -->
                    ...
                    <div class="header-left">
                        <nav class="main-nav">
                            <ul class="menu sf-arrows">
                                <li class="megamenu-title active">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><a href="#"><span>Tops<span class="tip tip-new">New</span></span></a></li>
                                                            </ul>
                                                        </div><!-- End .col-md-6 -->
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-md-6">
                                                <div class="menu-col">
                                                    <div class="row">
                                                        <div class="col-md-12">
															<div class="menu-title">Kid's</div><!-- End .menu-title -->
                                                            <ul>
                                                                <li><a href="#">Ethnic Wear</a></li>
                                                                <li><a href="#">Saree</a></li>
                                                                <li><a href="#">Blouse</a></li>
								...
								<li>
                                    ...
                                    <div class="megamenu megamenu-md" style="width:200px;">
                                        <div class="row no-gutters">
                                            <div class="col-md-12">
                                                <div class="banner banner-overlay">
                                                    <a href="#" class="banner banner-menu">
                            ...
                            <div class="intro-slider owl-carousel owl-simple owl-light" data-toggle="owl" 
                                ...
                                <div class="intro-slide">
                                    ...
                                    <div class="intro-content">
                                        ...
                                        <div class="intro-text text-white">2022</div><!-- End .intro-text -->
                            ...
                            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        <a href="#">
                                            <img src="assets/images/products/product-1-1.jpg" alt="Product image" class="product-image">
                                            <img src="assets/images/products/product-1-2.jpg" alt="Product image" class="product-image-hover">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <div class="product-nav product-nav-thumbs">
                                            <a href="#" class="active">
                                                <img src="assets/images/products/product-1-thumb.jpg" alt="product desc">
                                            </a>
                                            <a href="#">
                                                <img src="assets/images/products/product-1-2-thumb.jpg" alt="product desc">
                                            </a>
                                            <a href="#">
                                                <img src="assets/images/products/product-1-3-thumb.jpg" alt="product desc">
                                            </a>
                                        </div><!-- End .product-nav -->
                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        <a href="#">
                                            <img src="assets/images/products/product-2-1.jpg" alt="Product image" class="product-image">
                                            <img src="assets/images/products/product-2-2.jpg" alt="Product image" class="product-image-hover">
                                        </a>
                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        ...
                                        <a href="#">
                                            <img src="assets/images/products/product-3-1.jpg" alt="Product image" class="product-image">
                                            <img src="assets/images/products/product-3-2.jpg" alt="Product image" class="product-image-hover">
                                        </a>
                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        <a href="#">
                                            <img src="assets/images/products/product-4-1.jpg" alt="Product image" class="product-image">
                                            <img src="assets/images/products/product-4-2.jpg" alt="Product image" class="product-image-hover">
                                        </a>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="banner banner-overlay product-banner">
                            <a href="#">
                                <img src="assets/images/banners/banner-5.jpg" alt="banner image">
                            </a>
                            <div class="banner-content">
                                ...
                                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                    ...
                                    <div class="product product-7">
                                        <figure class="product-media">
                                            ...
                                            <a href="#">
                                                <img src="assets/images/products/product-5-1.jpg" alt="Product image" class="product-image">
                                                <img src="assets/images/products/product-5-2.jpg" alt="Product image" class="product-image-hover">
                                            </a>
                                    ...
                                    <div class="product product-7">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="assets/images/products/product-6-1.jpg" alt="Product image" class="product-image">
                                                <img src="assets/images/products/product-6-2.jpg" alt="Product image" class="product-image-hover">
                                            </a>
                                    ...
                                    <div class="product product-7">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="assets/images/products/product-7-1.jpg" alt="Product image" class="product-image">
                                                <img src="assets/images/products/product-7-2.jpg" alt="Product image" class="product-image-hover">
                                            </a>
            ...
            <div class="container pb-2">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="banner banner-overlay product-banner">
                            <a href="#">
                                <img src="assets/images/banners/banner-6.jpg" alt="banner image">
                            </a>
                            <div class="banner-content">
                                <div class="banner-top">
                                    <div class="banner-title text-white text-center">
                            ...
                            <div class="tab-pane p-0 fade show active" id="bags-women-tab" role="tabpanel" aria-labelledby="bags-women-link">
                                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                    ...
                                    <div class="product product-7 text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="assets/images/products/product-8-1.jpg" alt="Product image" class="product-image">
                                                <img src="assets/images/products/product-8-2.jpg" alt="Product image" class="product-image-hover">
                                            </a>
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-title"><a href="#">Small shoulder bag</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                $14.99
                                            </div><!-- End .product-price -->
                                    ...
                                    <div class="product product-7 text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="assets/images/products/product-9-1.jpg" alt="Product image" class="product-image">
                                                <img src="assets/images/products/product-9-2.jpg" alt="Product image" class="product-image-hover">
                                            </a>
                                    ...
                                    <div class="product product-7 text-center">
                                        <figure class="product-media">
                                            <a href="#">
                                                <img src="assets/images/products/product-10-1.jpg" alt="Product image" class="product-image">
                                                <img src="assets/images/products/product-10-2.jpg" alt="Product image" class="product-image-hover">
                                            </a>
                                        ...
                                        <div class="product-body">
                                            ...
                                            <div class="product-nav product-nav-thumbs">
                                                <a href="#" class="active">
                                                    <img src="assets/images/products/product-10-thumb.jpg" alt="product desc">
                                                </a>
                                                <a href="#">
                                                    <img src="assets/images/products/product-10-2-thumb.jpg" alt="product desc">
                                                </a>
                                            </div><!-- End .product-nav -->
                                        </div><!-- End .product-body -->
                                    </div><!-- End .product -->
                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-10 col-md-8 col-lg-6">
                            <div class="cta-heading text-center">
                                <h3 class="cta-title">Sign Up for updates from Rtaze</h3><!-- End .cta-title -->
        ...
        <footer class="footer footer-2">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="widget widget-about">
                                <img src="assets/images/page/logo_footer.png" class="footer-logo" alt="Footer Logo" width="150" height="25">
                                <p>Welcome to the world of rtaze, where we aim to offer quality, affordable and inspiring clothing for the young woman who wants to look good and have fun with her look. As our customer, you are at the heart of everything we do. </p>
                                
                                <div class="widget-about-info">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-4">
                                            <span class="widget-about-title">Got Question? Call us 24/7</span>
                                            <a href="tel:123456789">+91-9998284428</a>
                                        </div><!-- End .col-sm-6 -->
                        ...
                        <div class="col-sm-4 col-lg-2">
                            <div class="widget">
                                ...
                                <ul class="widget-list">
                                    <li><a href="#">About Rtaze</a></li>
                                    <li><a href="#">How to shop on Rtaze</a></li>
                                    <li><a href="#">FAQ</a></li>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <p class="footer-copyright">Copyright © 2019 Rtaze Store. All Rights Reserved.</p><!-- End .footer-copyright -->
                ...
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            <img src="assets/images/page/logo_footer.png" class="logo" alt="logo" width="100" height="15">
                            <h2 class="banner-title">get <span>25<light>%</light></span> off</h2>
                            <p>Subscribe to the Rtaze newsletter to receive timely updates from your favorite products.</p>
                            <form action="#">
                    ...
                    <div class="col-xl-2-5col col-lg-5 ">
                        <img src="assets/images/page/img-1.jpg" class="newsletter-img" alt="newsletter">
                    </div>
                </div>
            </div>
        </div>
